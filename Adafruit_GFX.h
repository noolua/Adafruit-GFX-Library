...
public:
  ...
  */
  ...
  size_t write_ascii(uint8_t c);
  void setUUFont(const uufont_t *f = NULL);
...
protected:
  ...
  void charBounds_ascii(unsigned char c, int16_t *x, int16_t *y, int16_t *minx, int16_t *miny, int16_t *maxx, int16_t *maxy);
